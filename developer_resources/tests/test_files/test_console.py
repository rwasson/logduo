...
from developer_resources.pytest_toolkit.test_utils import _read_file, _find_main_log
from logduo.internals.formatters.message_prep import MessageKind
from logduo.internals.sinks.console import (
    _build_console_message, _initialize_console,
)
...
from logduo.internals.sinks.console import _emit_console_payload
