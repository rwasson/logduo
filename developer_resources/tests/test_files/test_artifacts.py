...
from logduo.internals.artifacts.build_config_table import _get_toml_display_value, \
...
def test_07_write_example_scripts_copies_examples(
    ...
    assert (examples_dir / "first_script.py").exists()
    assert (examples_dir / "rich_and_ansi.py").exists()
    assert (examples_dir / "parent.py").exists()
    assert (examples_dir / "parents_child.py").exists()
